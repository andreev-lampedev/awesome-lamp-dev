...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        // $schedule->command('awesomelampdev:check-package-urls')->weeklyOn(7, '20:00');
        // $schedule->command('awesomelampdev:send-unavailable-package-followup')->dailyAt('21:00');
        // $schedule->command('awesomelampdev:disable-unavailable-packages')->dailyAt('21:30');
    }
