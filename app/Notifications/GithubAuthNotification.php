...
class GithubAuthNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
            ->subject('Please authenticate your Awesome LampDev account with GitHub.')
            ->line('You did it! You snuck in to awesomelampdev.com before we were finished working on it 😘.')
            ...
            ->line('Thank you for being so excited to try Awesome LampDev!');
    }
