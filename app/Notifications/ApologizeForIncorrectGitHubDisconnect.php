...
class ApologizeForIncorrectGitHubDisconnect extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
            ...
            ->line("Yesterday you received an email from Awesome LampDev saying your package's URL can't be reached. However, this was due to an overeager notification script that didn't consider GitHub's rate limiting.")
            ...
            ->line('Thank you for listing your package(s) on Awesome LampDev!');
    }
}
