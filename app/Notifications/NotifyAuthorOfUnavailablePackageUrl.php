...
class NotifyAuthorOfUnavailablePackageUrl extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->line('Awesome LampDev recently found an error with the URL that we have listed for that package: ')
            ...
            ->line('Thank you for helping to keep Awesome LampDev up to date!');
    }
}
