...
<div class="max-w-4xl mx-auto pt-16 px-4 md:px-0">
    ...
    <div class="bg-white p-8 rounded-lg leading-loose text-gray-800 shadow sm:p-12">
        ...
        <p class="mb-4">A collaborator is anyone with a GitHub username: a person, a company, or an organization. Collaborators exist in Awesome LampDev to represent the primary <strong>author</strong> of a package or a <strong>contributor</strong> to the package.</p>
