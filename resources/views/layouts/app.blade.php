...
<head>
    ...
    <title>@yield('title', 'Home') - {{ config('app.name', 'Awesome LampDev') }}</title>
    @yield('meta')
...
<body class="bg-gray-200 font-sans font-normal">
    <div class="bg-custom-indigo-darkest">
        <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between py-4">
            <a href="/" class="flex items-center text-white font-bold text-md no-underline uppercase">
                <img src="/images/nova.svg" alt="Laravel Nova icon" class="h-5" />
                <span class="ml-1">Awe</span>
                <span>some</span>
            </a>
   ...
   <div
        class="flex flex-col sm:flex-row justify-start sm:justify-center bg-custom-indigo-darker text-white text-center mt-8 px-4 py-4">
        <p class="flex justify-center inline mb-6 sm:mb-0">
            COPYRIGHT LAMPDEV 2021. ALL RIGHTS RESERVED.
        </p>

        <span class="hidden sm:block mx-4">|</span>
        <a target="_blank" href="https://www.upwork.com/agencies/~01cf0a75bf669e164f"
            class="font-bold text-white no-underline hover:underline">Upwork</a>

        <span class="hidden sm:block mx-4">|</span>
        <a target="_blank" href="https://www.facebook.com/LAMPDevUkraine"
            class="font-bold text-white no-underline hover:underline">Facebook</a>

        <span class="hidden sm:block mx-4">|</span>
        <a target="_blank" href="https://github.com/lampdev"
            class="font-bold text-white no-underline hover:underline">Github</a>
    </div>
